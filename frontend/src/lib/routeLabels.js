...
const staticRouteLabels = {
  ...
  '/actions': 'Actions',
  '/library': 'Strategy',
  '/settings/visual-management/boards': 'Visual Management',
  '/settings/visual-management/templates': 'Templates',
  '/settings/visual-management/screens': 'Screens',
  '/settings/visual-management/pair-displays': 'Pair Displays',
  '/settings/visual-management/analytics': 'Analytics',
