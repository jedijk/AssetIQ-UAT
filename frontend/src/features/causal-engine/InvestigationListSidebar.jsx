import { FileText, Search, Plus, Target, Clock, Loader2 } from "lucide-react";
...
export function InvestigationListSidebar({
  investigations,
  loading,
  selectedId,
  onSelect,
    ...
    <div className="w-80 flex-shrink-0 h-full flex flex-col bg-slate-50 border-r border-slate-200">
      <div className="p-4 bg-white border-b border-slate-200">
        ...
        <div className="relative">
          ...
          <Input
            placeholder={t("causal.searchInvestigations")}
            value={searchQuery}
            onChange={(e) => onSearchChange(e.target.value)}
            className="pl-9 h-11 bg-slate-50 border-slate-200 focus:bg-white"
            data-testid="search-investigations"
          />
        </div>
      </div>
            ...
            {investigations.map((inv) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-semibold text-slate-900 text-sm line-clamp-2 mb-2 leading-snug">
                    {inv.title}
                  </h3>
                    ...
                    {inv.asset_name && (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="truncate max-w-[120px]">
                          ...
                          {inv.equipment_tag && (
                            <span className="text-slate-400 ml-1">({inv.equipment_tag})</span>
                          )}
                        </span>
                      </div>
                    )}
