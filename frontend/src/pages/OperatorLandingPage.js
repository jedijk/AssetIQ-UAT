    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-2xl p-6 bg-amber-50 border border-amber-200 text-amber-700 w-full shadow-lg shadow-amber-100/40 active:scale-[0.97] active:shadow-sm transition-all duration-150"
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-2xl p-6 bg-purple-50 border border-purple-200 text-purple-700 shadow-lg shadow-purple-100/40 active:scale-[0.97] active:shadow-sm transition-all duration-150"
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-2xl p-6 bg-green-50 border border-green-200 text-green-700 shadow-lg shadow-green-100/40 active:scale-[0.97] active:shadow-sm transition-all duration-150"
