    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-2xl p-6 bg-amber-400 text-white w-full shadow-lg shadow-amber-400/20 active:scale-[0.97] active:shadow-sm transition-all duration-150"
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-2xl p-6 bg-blue-500 text-white shadow-lg shadow-blue-500/20 active:scale-[0.97] active:shadow-sm transition-all duration-150"
