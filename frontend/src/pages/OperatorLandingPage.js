    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        <button
          ...
          className="flex items-center justify-center gap-3 rounded-2xl p-6 bg-amber-400 text-amber-950 w-full shadow-lg shadow-amber-400/15 active:scale-[0.97] active:shadow-sm transition-all duration-150"
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-2xl p-6 bg-violet-300 text-violet-950 shadow-lg shadow-violet-300/15 active:scale-[0.97] active:shadow-sm transition-all duration-150"
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-3 rounded-2xl p-6 bg-emerald-300 text-emerald-950 shadow-lg shadow-emerald-300/15 active:scale-[0.97] active:shadow-sm transition-all duration-150"
