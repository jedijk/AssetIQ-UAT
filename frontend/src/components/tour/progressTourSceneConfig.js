...
const PROGRESS_TOUR_SCENE_DEFS = [
  ...
  },
  {
    ...
    target: '[data-testid="menu-link-failure-mode"], [data-testid="workspace-more-menu"]',
    cardPosition: "left",
    pulseTarget: true,
    spotlightZoom: 1.15,
  ...
  },
  {
    ...
    navigateTo: "workspace",
    openWorkspaceMenu: true,
    target: '[data-testid="menu-link-equipment"], [data-testid="workspace-more-menu"]',
    cardPosition: "left",
    pulseTarget: true,
    spotlightZoom: 1.15,
    transition: "spotlight",
  ...
  },
  {
    ...
    chapterKey: "recommendations",
    navigateTo: "workspace",
    target: '[data-testid="run-ai-recommendations-btn"], [data-testid="recommended-actions-ai-control"]',
    scrollPanel: '[data-testid="recommended-actions-panel"]',
    cardPosition: "left",
    pulseTarget: true,
    spotlightZoom: 1.25,
    transition: "spotlight",
