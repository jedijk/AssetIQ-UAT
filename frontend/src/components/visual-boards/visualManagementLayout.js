...
export const VMB_PAGE_TITLE_CLASS =
  "text-xl sm:text-2xl font-bold text-slate-900 flex items-center gap-2 break-words";

export const VMB_PAGE_ACTIONS_CLASS =
  "flex flex-wrap gap-2 w-full sm:w-auto shrink-0";
