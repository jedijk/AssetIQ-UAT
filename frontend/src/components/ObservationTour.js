...
const MOBILE_LAYOUT_TOUR_STEPS = [
  {
    id: "welcome",
    title: "Report an Observation",
    description: "On mobile, report observations by selecting equipment from the hierarchy. Let's walk through the flow!",
    icon: Sparkles,
    target: null,
    position: "center",
    ensureChat: "closed",
...
const MOBILE_APP_TOUR_STEPS = [
  {
    id: "welcome",
    title: "Report an Observation",
    description: "Report observations by selecting equipment on the Home tab. We'll show the mobile reporting flow.",
    icon: Sparkles,
    target: null,
    position: "center",
    ensureChat: "closed",
