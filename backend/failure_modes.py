...
FAILURE_MODES_LIBRARY = [
  ...
  # ============= NEW CATEGORIES FROM FMEA 2022-2023 =============

  # Material Handling (IDs 139-148)
  {"id":139,"category":"Material Handling","equipment":"Raw Material","failure_mode":"Material Out of Spec (Size)","keywords":["particle size","too large","too small","granulate size","crumb size","material spec"],"severity":7,"occurrence":6,"detectability":4,"rpn":168,"recommended_actions":["Perform particle size test","Agree specifications with supplier","Visual inspection on receipt","Reject non-conforming material"],"equipment_type_ids":[]},
  {"id":140,"category":"Material Handling","equipment":"Raw Material","failure_mode":"Material Out of Spec (Moisture)","keywords":["moisture","wet","moisture content","damp material","humidity"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Perform moisture test","Store in dry conditions","Check supplier certificates","Reject wet material"],"equipment_type_ids":[]},
  {"id":141,"category":"Material Handling","equipment":"Raw Material","failure_mode":"Material Contamination","keywords":["contamination","pollution","dirty","foreign material","debris"],"severity":8,"occurrence":5,"detectability":5,"rpn":200,"recommended_actions":["Visual inspection","Install metal detector","Screen incoming material","Supplier quality audit"],"equipment_type_ids":[]},
  {"id":142,"category":"Material Handling","equipment":"Ordering","failure_mode":"Material Ordered Too Early","keywords":["overstock","ordered early","excess inventory","storage issue"],"severity":4,"occurrence":5,"detectability":6,"rpn":120,"recommended_actions":["Improve supply chain visibility","Train on inventory management","Use ERP system alerts","Review order patterns"],"equipment_type_ids":[]},
  {"id":143,"category":"Material Handling","equipment":"Ordering","failure_mode":"Material Ordered Too Late","keywords":["stockout","ordered late","production delay","shortage"],"severity":8,"occurrence":5,"detectability":5,"rpn":200,"recommended_actions":["Set reorder points","Improve lead time tracking","Train on supply chain management","Automate ordering alerts"],"equipment_type_ids":[]},
  {"id":144,"category":"Material Handling","equipment":"Hopper/Bunker","failure_mode":"Wrong Material in Bunker","keywords":["wrong material","incorrect material","material mix-up","bunker error"],"severity":9,"occurrence":3,"detectability":6,"rpn":162,"recommended_actions":["Label all containers clearly","Verify material before loading","Two-person verification","Barcode scanning system"],"equipment_type_ids":[]},
  {"id":145,"category":"Material Handling","equipment":"Hopper/Bunker","failure_mode":"Material Bridging","keywords":["bridging","rat-holing","flow blockage","hopper bridge","material stuck"],"severity":6,"occurrence":7,"detectability":3,"rpn":126,"recommended_actions":["Install vibrator or agitator","Modify hopper geometry","Use flow aids","Reduce moisture content"],"equipment_type_ids":[]},
  {"id":146,"category":"Material Handling","equipment":"Hopper/Bunker","failure_mode":"Bunker Empty During Production","keywords":["bunker empty","hopper empty","material runout","no material"],"severity":8,"occurrence":5,"detectability":3,"rpn":120,"recommended_actions":["Install level sensors","Set up low-level alarms","Improve monitoring","Assign refill responsibility"],"equipment_type_ids":[]},
  {"id":147,"category":"Material Handling","equipment":"Magnet","failure_mode":"Magnet Not Installed","keywords":["magnet missing","no magnet","magnet not placed","metal protection"],"severity":9,"occurrence":3,"detectability":5,"rpn":135,"recommended_actions":["Add to startup checklist","Train on work instruction","Visual verification","Interlock if possible"],"equipment_type_ids":[]},
  {"id":148,"category":"Material Handling","equipment":"Magnet","failure_mode":"Magnet Contaminated","keywords":["magnet dirty","magnet contaminated","metal buildup","magnet cleaning"],"severity":7,"occurrence":6,"detectability":4,"rpn":168,"recommended_actions":["Clean magnet regularly","Add to daily checklist","Train on cleaning procedure","Inspect before each shift"],"equipment_type_ids":[]},

  # Quality Control (IDs 149-160)
  {"id":149,"category":"Quality Control","equipment":"Test Equipment","failure_mode":"Calibration Overdue","keywords":["calibration overdue","not calibrated","calibration expired","out of calibration"],"severity":8,"occurrence":5,"detectability":6,"rpn":240,"recommended_actions":["Implement calibration tracking system","Set calendar reminders","Internal audit","Use calibration stickers with due dates"],"equipment_type_ids":["sensor_pressure","sensor_temperature","sensor_flow"]},
  {"id":150,"category":"Quality Control","equipment":"Testing","failure_mode":"Test Not Performed Properly","keywords":["test error","incorrect test","procedure not followed","test failure"],"severity":7,"occurrence":6,"detectability":6,"rpn":252,"recommended_actions":["Train on test procedures","Supervision by experienced staff","Update work instructions","Competency assessment"],"equipment_type_ids":[]},
  {"id":151,"category":"Quality Control","equipment":"Testing","failure_mode":"Sample Taking Error","keywords":["sampling error","wrong sample","sample size","sampling procedure"],"severity":6,"occurrence":6,"detectability":5,"rpn":180,"recommended_actions":["Train on sampling procedures","Define sample requirements","Use standard sample containers","Document sampling points"],"equipment_type_ids":[]},
  {"id":152,"category":"Quality Control","equipment":"Testing","failure_mode":"Forgetting to Take Samples","keywords":["missed sample","no sample","forgot sample","sampling omission"],"severity":7,"occurrence":5,"detectability":6,"rpn":210,"recommended_actions":["Add to production checklist","Set timer reminders","Assign sampling responsibility","Supervisor verification"],"equipment_type_ids":[]},
  {"id":153,"category":"Quality Control","equipment":"Testing","failure_mode":"Test Result Out of Specification","keywords":["out of spec","OOS","specification failure","test failed","non-conformance"],"severity":8,"occurrence":6,"detectability":4,"rpn":192,"recommended_actions":["Investigate root cause","Quarantine material","Retest if appropriate","Document non-conformance"],"equipment_type_ids":[]},
  {"id":154,"category":"Quality Control","equipment":"Work Instruction","failure_mode":"Work Instruction Outdated","keywords":["WI outdated","procedure outdated","old instruction","not current","document control"],"severity":7,"occurrence":5,"detectability":7,"rpn":245,"recommended_actions":["Regular document review","Version control system","Internal audit","Staff feedback mechanism"],"equipment_type_ids":[]},
  {"id":155,"category":"Quality Control","equipment":"Mooney Tester","failure_mode":"Mooney Test Failure","keywords":["mooney","viscosity test","mooney viscometer","rheology"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Calibrate regularly","Train operators","Follow test procedure","Maintain equipment"],"equipment_type_ids":[]},
  {"id":156,"category":"Quality Control","equipment":"TGA Tester","failure_mode":"TGA Test Failure","keywords":["TGA","thermogravimetric","composition test","ash content"],"severity":7,"occurrence":4,"detectability":5,"rpn":140,"recommended_actions":["Calibrate regularly","Clean crucibles","Train operators","Verify gas supply"],"equipment_type_ids":[]},
  {"id":157,"category":"Quality Control","equipment":"Tensile Tester","failure_mode":"Tensile/Hardness Test Failure","keywords":["tensile","elongation","hardness","mechanical test","tensile strength"],"severity":7,"occurrence":4,"detectability":5,"rpn":140,"recommended_actions":["Calibrate equipment","Prepare samples correctly","Follow test standards","Maintain grips and fixtures"],"equipment_type_ids":[]},
  {"id":158,"category":"Quality Control","equipment":"Moisture Meter","failure_mode":"Moisture Meter Failure","keywords":["moisture meter","moisture tester","moisture measurement"],"severity":6,"occurrence":5,"detectability":5,"rpn":150,"recommended_actions":["Calibrate regularly","Check against reference","Replace if unreliable","Train operators"],"equipment_type_ids":[]},
  {"id":159,"category":"Quality Control","equipment":"Metal Detector","failure_mode":"Metal Detector Malfunction","keywords":["metal detector","metal detection","false alarm","missed detection"],"severity":9,"occurrence":4,"detectability":5,"rpn":180,"recommended_actions":["Daily verification with test pieces","Calibrate sensitivity","Train operators","Document all alarms"],"equipment_type_ids":[]},
  {"id":160,"category":"Quality Control","equipment":"Metal Detector","failure_mode":"Metal Detector Setup Error","keywords":["detector setup","teaching error","sensitivity setting","metal detector calibration"],"severity":8,"occurrence":4,"detectability":6,"rpn":192,"recommended_actions":["Restrict setup to trained personnel","Document settings","Verify with test pieces","Supervisor approval"],"equipment_type_ids":[]},

  # Dosing System (IDs 161-166)
  {"id":161,"category":"Dosing","equipment":"Dosing System","failure_mode":"Incorrect Dosing Rate","keywords":["dosing error","feed rate","wrong dose","metering error"],"severity":8,"occurrence":5,"detectability":5,"rpn":200,"recommended_actions":["Calibrate dosing system","Monitor feed rate","Verify settings","Train operators"],"equipment_type_ids":["extruder"]},
  {"id":162,"category":"Dosing","equipment":"Dosing System","failure_mode":"Dosing System Not Refilled","keywords":["dosing empty","not refilled","feed starved","dosing hopper empty"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Install level sensors","Set refill alarms","Assign responsibility","Monitor continuously"],"equipment_type_ids":["extruder"]},
  {"id":163,"category":"Dosing","equipment":"Dosing System","failure_mode":"RPM to Output Ratio Imbalance","keywords":["RPM ratio","throughput imbalance","kg/hr ratio","screw speed"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Train on proper settings","Monitor output rate","Adjust parameters","Document optimal settings"],"equipment_type_ids":["extruder"]},
  {"id":164,"category":"Dosing","equipment":"CO2 System","failure_mode":"Incorrect CO2 Dosage","keywords":["CO2 dosage","CO2 injection","supercritical CO2","CO2 error"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Verify CO2 settings","Monitor injection rate","Train operators","Check supply pressure"],"equipment_type_ids":["extruder"]},
  {"id":165,"category":"Dosing","equipment":"CO2 System","failure_mode":"CO2 Not Activated","keywords":["CO2 off","CO2 not on","forgot CO2","CO2 startup"],"severity":8,"occurrence":4,"detectability":4,"rpn":128,"recommended_actions":["Add to startup checklist","Install indicator lights","Train on procedure","Interlock with production"],"equipment_type_ids":["extruder"]},
  {"id":166,"category":"Dosing","equipment":"CO2 System","failure_mode":"CO2 Supply Shortage","keywords":["CO2 shortage","no CO2","CO2 empty","CO2 ordering"],"severity":8,"occurrence":4,"detectability":5,"rpn":160,"recommended_actions":["Monitor tank levels","Set reorder points","Automate ordering","Maintain buffer stock"],"equipment_type_ids":["extruder"]},

  # Ventilation/Extraction (IDs 167-172)
  {"id":167,"category":"Ventilation","equipment":"Extraction System","failure_mode":"Extraction System Failure","keywords":["extraction","ventilation failure","fume extraction","exhaust failure"],"severity":8,"occurrence":4,"detectability":5,"rpn":160,"recommended_actions":["Regular maintenance","Check fan operation","Inspect ductwork","Monitor airflow"],"equipment_type_ids":[]},
  {"id":168,"category":"Ventilation","equipment":"Filter","failure_mode":"End Filter Clogged","keywords":["filter clogged","dirty filter","filter blockage","biofilter"],"severity":7,"occurrence":6,"detectability":4,"rpn":168,"recommended_actions":["Replace filters regularly","Monitor pressure drop","Clean or replace when indicated","Document filter changes"],"equipment_type_ids":[]},
  {"id":169,"category":"Ventilation","equipment":"Damper","failure_mode":"Ventilation Damper Closed","keywords":["damper closed","slider closed","ventilation blocked","airflow blocked"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Add to startup checklist","Visual inspection","Install position indicators","Train operators"],"equipment_type_ids":[]},
  {"id":170,"category":"Ventilation","equipment":"Extraction Hood","failure_mode":"Extraction Hood Ineffective","keywords":["hood ineffective","poor extraction","fumes escaping","capture velocity"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Check hood design","Verify airflow rate","Clean hood regularly","Adjust positioning"],"equipment_type_ids":[]},
  {"id":171,"category":"Ventilation","equipment":"Sludge Tank","failure_mode":"Sludge Tank Leak","keywords":["sludge leak","tank leak","effluent leak","sludge spill"],"severity":8,"occurrence":4,"detectability":5,"rpn":160,"recommended_actions":["Daily inspection","Check seals and connections","Install leak detection","Maintain containment"],"equipment_type_ids":["vessel_storage"]},
  {"id":172,"category":"Ventilation","equipment":"Sludge Pump","failure_mode":"Sludge Pump Failure","keywords":["sludge pump","pump failure","effluent pump","tank pump"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Regular maintenance","Check pump operation daily","Monitor discharge","Clean pump regularly"],"equipment_type_ids":["pump_centrifugal"]},

  # Cutting/Packaging (IDs 173-188)
  {"id":173,"category":"Cutting","equipment":"Cutting Knife","failure_mode":"Knife Wear/Dull Blade","keywords":["dull knife","knife wear","blunt blade","cutting quality"],"severity":6,"occurrence":7,"detectability":4,"rpn":168,"recommended_actions":["Regular knife inspection","Replace on schedule","Monitor cut quality","Use quality blades"],"equipment_type_ids":[]},
  {"id":174,"category":"Cutting","equipment":"Cutting Knife","failure_mode":"Incorrect Cut","keywords":["double cut","miscut","uneven cut","cutting error"],"severity":6,"occurrence":5,"detectability":4,"rpn":120,"recommended_actions":["Adjust knife alignment","Check machine timing","Train operators","Verify settings"],"equipment_type_ids":[]},
  {"id":175,"category":"Cutting","equipment":"Cutting Unit","failure_mode":"Knife Alignment Error","keywords":["knife alignment","cutting surfaces","blade gap","knife position"],"severity":6,"occurrence":4,"detectability":5,"rpn":120,"recommended_actions":["Check alignment regularly","Adjust per specification","Train maintenance staff","Document settings"],"equipment_type_ids":[]},
  {"id":176,"category":"Cutting","equipment":"Sheet","failure_mode":"Sheet Length Error","keywords":["length error","short sheet","long sheet","cut length","sheet measurement"],"severity":6,"occurrence":5,"detectability":3,"rpn":90,"recommended_actions":["Calibrate length sensor","Verify measurement system","100% inspection","Adjust cutting parameters"],"equipment_type_ids":[]},
  {"id":177,"category":"Cutting","equipment":"Sheet","failure_mode":"Sheet Weight Error","keywords":["weight error","overweight","underweight","sheet weight"],"severity":6,"occurrence":5,"detectability":3,"rpn":90,"recommended_actions":["Calibrate scales","100% weighing","Adjust sheet dimensions","Monitor process"],"equipment_type_ids":[]},
  {"id":178,"category":"Packaging","equipment":"Scale","failure_mode":"Scale Calibration Error","keywords":["scale error","weighing error","scale drift","incorrect weight"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Regular calibration","Check with test weights","Document calibration","Replace if unreliable"],"equipment_type_ids":[]},
  {"id":179,"category":"Packaging","equipment":"Scale","failure_mode":"Scale Deviation Setting Error","keywords":["tolerance setting","deviation","scale setup","acceptance limits"],"severity":6,"occurrence":4,"detectability":6,"rpn":144,"recommended_actions":["Verify settings before use","Document standard settings","Train operators","Supervisor verification"],"equipment_type_ids":[]},
  {"id":180,"category":"Packaging","equipment":"Pallet","failure_mode":"Pallet Damage","keywords":["damaged pallet","broken pallet","pallet condition","pallet quality"],"severity":6,"occurrence":5,"detectability":4,"rpn":120,"recommended_actions":["Inspect pallets before use","Reject damaged pallets","Supplier quality control","Handle carefully"],"equipment_type_ids":[]},
  {"id":181,"category":"Packaging","equipment":"Pallet","failure_mode":"Pallet Positioning Error","keywords":["pallet position","crooked pallet","stacking error","placement error"],"severity":5,"occurrence":5,"detectability":4,"rpn":100,"recommended_actions":["Mark floor positions","Train operators","Visual guides","Verify before stacking"],"equipment_type_ids":[]},
  {"id":182,"category":"Packaging","equipment":"Shrink Wrap","failure_mode":"Shrink Wrap Failure","keywords":["shrink wrap","film failure","wrap not adhering","packaging film"],"severity":5,"occurrence":5,"detectability":4,"rpn":100,"recommended_actions":["Cool product before wrapping","Check wrap temperature","Use correct film","Train operators"],"equipment_type_ids":[]},
  {"id":183,"category":"Packaging","equipment":"Strapping","failure_mode":"Strapping Loose","keywords":["loose straps","strap tension","strapping failure","unsecured load"],"severity":6,"occurrence":5,"detectability":4,"rpn":120,"recommended_actions":["Check strap tension","Train on strapping technique","Verify before shipping","Use proper equipment"],"equipment_type_ids":[]},
  {"id":184,"category":"Packaging","equipment":"Label","failure_mode":"Label Not Readable","keywords":["illegible label","print quality","label faded","barcode error"],"severity":7,"occurrence":4,"detectability":4,"rpn":112,"recommended_actions":["Check printer regularly","Use quality labels","Verify each label","Replace ribbon/ink"],"equipment_type_ids":[]},
  {"id":185,"category":"Packaging","equipment":"Label","failure_mode":"Label Missing","keywords":["no label","missing label","unlabeled","label not attached"],"severity":8,"occurrence":4,"detectability":4,"rpn":128,"recommended_actions":["Add to checklist","Two-person verification","Visual inspection","Automate labeling"],"equipment_type_ids":[]},
  {"id":186,"category":"Packaging","equipment":"Label","failure_mode":"Wrong Label Applied","keywords":["wrong label","label error","mislabeled","incorrect label"],"severity":9,"occurrence":3,"detectability":5,"rpn":135,"recommended_actions":["Verify label before applying","Two-person check","Barcode verification","Clear labeling procedure"],"equipment_type_ids":[]},
  {"id":187,"category":"Packaging","equipment":"Documents","failure_mode":"Documents Missing","keywords":["missing documents","no paperwork","documents not included","shipping documents"],"severity":7,"occurrence":4,"detectability":4,"rpn":112,"recommended_actions":["Final inspection checklist","Two-person verification","Document staging area","Shipping procedure"],"equipment_type_ids":[]},
  {"id":188,"category":"Packaging","equipment":"Documents","failure_mode":"Wrong Documents Included","keywords":["wrong documents","document error","incorrect paperwork","document mix-up"],"severity":8,"occurrence":3,"detectability":5,"rpn":120,"recommended_actions":["Match documents to order","Two-person verification","Organized staging","Clear procedures"],"equipment_type_ids":[]},

  # Cooling/Water Systems (IDs 189-194)
  {"id":189,"category":"Cooling","equipment":"Water Tank","failure_mode":"Cooling Water Insufficient","keywords":["cooling water","water level","tank level","coolant low"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Monitor water level","Install level sensors","Check during pumping","Maintain minimum level"],"equipment_type_ids":["heat_exchanger"]},
  {"id":190,"category":"Cooling","equipment":"Water Tank","failure_mode":"Cooling Water Not Turned On","keywords":["cooling off","water not on","forgot cooling","startup error"],"severity":8,"occurrence":4,"detectability":4,"rpn":128,"recommended_actions":["Add to startup checklist","Install indicator","Interlock with production","Train operators"],"equipment_type_ids":["heat_exchanger"]},
  {"id":191,"category":"Cooling","equipment":"Water Tank","failure_mode":"Cooling Water Temperature Error","keywords":["water temperature","cooling temperature","tank temp","too hot","too cold"],"severity":6,"occurrence":5,"detectability":5,"rpn":150,"recommended_actions":["Monitor temperature","Adjust cooling system","Check heat load","Maintain equipment"],"equipment_type_ids":["heat_exchanger"]},
  {"id":192,"category":"Cooling","equipment":"Roller Belt","failure_mode":"Roller Belt Positioning Error","keywords":["roller belt","conveyor position","belt alignment","spacing error"],"severity":5,"occurrence":5,"detectability":4,"rpn":100,"recommended_actions":["Train on setup","Mark correct positions","Visual guides","Verify before start"],"equipment_type_ids":[]},
  {"id":193,"category":"Cooling","equipment":"Water Bowl","failure_mode":"Water Bowl Speed Error","keywords":["bowl speed","water tank speed","conveyor speed","speed setting"],"severity":5,"occurrence":5,"detectability":5,"rpn":125,"recommended_actions":["Document optimal settings","Train operators","Verify speed settings","Adjust as needed"],"equipment_type_ids":[]},
  {"id":194,"category":"Cooling","equipment":"Material","failure_mode":"Material Cracking","keywords":["material crack","cracking","tear","material damage","brittle"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Check material properties","Adjust process parameters","Reduce stress","Investigate root cause"],"equipment_type_ids":["extruder"]},

  # Mechanical/Conveyor (IDs 195-200)
  {"id":195,"category":"Mechanical","equipment":"Chain","failure_mode":"Chain Loose/Worn","keywords":["chain loose","chain wear","chain tension","drive chain"],"severity":7,"occurrence":5,"detectability":5,"rpn":175,"recommended_actions":["Regular tension checks","Lubricate chain","Replace when worn","Preventive maintenance"],"equipment_type_ids":[]},
  {"id":196,"category":"Mechanical","equipment":"Gripping Arm","failure_mode":"Gripping Arm Malfunction","keywords":["gripping arm","robot arm","pick and place","arm failure"],"severity":7,"occurrence":4,"detectability":5,"rpn":140,"recommended_actions":["Regular maintenance","Check sensors","Lubricate joints","Verify programming"],"equipment_type_ids":[]},
  {"id":197,"category":"Mechanical","equipment":"Clamp","failure_mode":"Clamp Not Secure","keywords":["clamp loose","insecure clamp","clamp failure","holding failure"],"severity":7,"occurrence":5,"detectability":4,"rpn":140,"recommended_actions":["Inspect before use","Train on procedure","Replace worn clamps","Verify grip"],"equipment_type_ids":[]},
  {"id":198,"category":"Mechanical","equipment":"Film Holder","failure_mode":"Film Placement Error","keywords":["film placement","film holder","film loading","film tension"],"severity":5,"occurrence":5,"detectability":4,"rpn":100,"recommended_actions":["Train on procedure","Visual guides","Check tension","Verify before start"],"equipment_type_ids":[]},
  {"id":199,"category":"Mechanical","equipment":"Sieve/Screen","failure_mode":"Sieve Not Installed","keywords":["sieve missing","screen missing","no sieve","filter screen"],"severity":8,"occurrence":3,"detectability":5,"rpn":120,"recommended_actions":["Add to startup checklist","Train operators","Visual inspection","Interlock if possible"],"equipment_type_ids":["extruder"]},
  {"id":200,"category":"Mechanical","equipment":"Sieve/Screen","failure_mode":"Sieve Incorrectly Installed","keywords":["sieve error","wrong mesh","screen misaligned","sieve setup"],"severity":7,"occurrence":4,"detectability":5,"rpn":140,"recommended_actions":["Train on installation","Verify mesh size","Check alignment","Document procedure"],"equipment_type_ids":["extruder"]},

  # Grinder - Rotating Equipment (IDs 201-215)
  {"id":201,"category":"Rotating","equipment":"Grinder","failure_mode":"Grinding Wheel Wear","keywords":["wheel wear","grinding wheel","abrasive wear","wheel degradation"],"severity":7,"occurrence":8,"detectability":4,"rpn":224,"recommended_actions":["Monitor wheel diameter","Replace worn wheels","Use proper dressing","Track wheel life"],"equipment_type_ids":["grinder"]},
  {"id":202,"category":"Rotating","equipment":"Grinder","failure_mode":"Grinding Wheel Breakage","keywords":["wheel break","wheel shatter","wheel crack","wheel failure"],"severity":10,"occurrence":3,"detectability":6,"rpn":180,"recommended_actions":["Ring test before mounting","Check max RPM rating","Inspect for cracks","Use proper guards"],"equipment_type_ids":["grinder"]},
  {"id":203,"category":"Rotating","equipment":"Grinder","failure_mode":"Spindle Bearing Failure","keywords":["spindle bearing","bearing noise","spindle vibration","bearing wear"],"severity":9,"occurrence":5,"detectability":4,"rpn":180,"recommended_actions":["Monitor vibration levels","Proper lubrication","Replace bearings proactively","Check alignment"],"equipment_type_ids":["grinder"]},
  {"id":204,"category":"Rotating","equipment":"Grinder","failure_mode":"Spindle Runout","keywords":["spindle runout","eccentricity","wobble","out of round"],"severity":8,"occurrence":4,"detectability":5,"rpn":160,"recommended_actions":["Measure runout regularly","Repair or replace spindle","Check mounting","Verify concentricity"],"equipment_type_ids":["grinder"]},
  {"id":205,"category":"Rotating","equipment":"Grinder","failure_mode":"Wheel Imbalance","keywords":["wheel imbalance","vibration","unbalanced","chatter"],"severity":7,"occurrence":6,"detectability":4,"rpn":168,"recommended_actions":["Balance wheel after dressing","Use balancing equipment","Check mounting flange","Replace damaged wheels"],"equipment_type_ids":["grinder"]},
  {"id":206,"category":"Rotating","equipment":"Grinder","failure_mode":"Motor Overload","keywords":["motor overload","overcurrent","motor trip","excessive load"],"severity":8,"occurrence":5,"detectability":5,"rpn":200,"recommended_actions":["Reduce feed rate","Check wheel sharpness","Verify motor sizing","Monitor current draw"],"equipment_type_ids":["grinder"]},
  {"id":207,"category":"Rotating","equipment":"Grinder","failure_mode":"Coolant System Failure","keywords":["coolant failure","no coolant","coolant pump","grinding fluid"],"severity":8,"occurrence":5,"detectability":4,"rpn":160,"recommended_actions":["Check coolant level","Clean filters","Maintain pump","Verify nozzle flow"],"equipment_type_ids":["grinder"]},
  {"id":208,"category":"Rotating","equipment":"Grinder","failure_mode":"Thermal Damage (Burn)","keywords":["grinding burn","thermal damage","discoloration","heat damage","workpiece burn"],"severity":9,"occurrence":5,"detectability":5,"rpn":225,"recommended_actions":["Reduce infeed rate","Increase coolant flow","Dress wheel more frequently","Check wheel grade"],"equipment_type_ids":["grinder"]},
  {"id":209,"category":"Rotating","equipment":"Grinder","failure_mode":"Surface Finish Deviation","keywords":["surface finish","roughness","poor finish","Ra value","surface quality"],"severity":6,"occurrence":6,"detectability":5,"rpn":180,"recommended_actions":["Dress wheel properly","Adjust feed rate","Check wheel grit size","Verify coolant application"],"equipment_type_ids":["grinder"]},
  {"id":210,"category":"Rotating","equipment":"Grinder","failure_mode":"Dimensional Inaccuracy","keywords":["dimension error","size variation","tolerance","out of spec","dimensional drift"],"severity":8,"occurrence":5,"detectability":4,"rpn":160,"recommended_actions":["Calibrate measuring system","Check thermal stability","Compensate for wheel wear","Verify workholding"],"equipment_type_ids":["grinder"]},
  {"id":211,"category":"Rotating","equipment":"Grinder","failure_mode":"Wheel Glazing","keywords":["wheel glazing","loaded wheel","clogged wheel","dull wheel"],"severity":6,"occurrence":7,"detectability":5,"rpn":210,"recommended_actions":["Dress wheel regularly","Use proper wheel grade","Adjust cutting parameters","Clean with dressing stick"],"equipment_type_ids":["grinder"]},
  {"id":212,"category":"Rotating","equipment":"Grinder","failure_mode":"Workholding Failure","keywords":["chuck failure","magnetic chuck","workholding","part slip","fixture failure"],"severity":9,"occurrence":4,"detectability":5,"rpn":180,"recommended_actions":["Check chuck condition","Verify clamping force","Clean holding surfaces","Inspect fixture regularly"],"equipment_type_ids":["grinder"]},
  {"id":213,"category":"Rotating","equipment":"Grinder","failure_mode":"Guard Interlock Failure","keywords":["guard interlock","safety interlock","guard sensor","safety switch"],"severity":10,"occurrence":3,"detectability":4,"rpn":120,"recommended_actions":["Test interlocks daily","Replace faulty switches","Never bypass guards","Document safety checks"],"equipment_type_ids":["grinder"]},
  {"id":214,"category":"Rotating","equipment":"Grinder","failure_mode":"Dresser Failure","keywords":["dresser failure","diamond dresser","dressing tool","dresser wear"],"severity":6,"occurrence":5,"detectability":5,"rpn":150,"recommended_actions":["Inspect dresser condition","Replace worn dressers","Use proper dressing technique","Track dresser life"],"equipment_type_ids":["grinder"]},
