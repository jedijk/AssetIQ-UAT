"""Legacy maintenance strategy v1 routes — service layer."""
...
async def generate_maintenance_strategy(
    request: GenerateStrategyRequest, current_user: dict,
):
...
async def generate_all_maintenance_strategies(
    request: GenerateAllStrategiesRequest, current_user: dict,
):
...
async def create_maintenance_strategy(
    data: MaintenanceStrategyCreate, current_user: dict,
):
...
async def update_maintenance_strategy(
    strategy_id: str,
    data: MaintenanceStrategyUpdate, current_user: dict,
):
...
async def increment_strategy_version(
    strategy_id: str,
    major: bool = False, *, current_user: dict,
):
