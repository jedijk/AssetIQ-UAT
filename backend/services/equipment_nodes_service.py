...
async def refresh_equipment_cache(user: dict,
):
...
async def get_equipment_nodes(user: dict,
):
...
async def get_all_installations(user: dict,
):
...
async def export_equipment_hierarchy_excel(user: dict,
):
...
async def get_equipment_node(user: dict,
    node_id: str,
):
...
async def create_equipment_node(user: dict,
...
async def update_equipment_node(user: dict,
    node_id: str,
...
async def get_deletion_impact(user: dict,
    node_id: str,
):
...
async def delete_equipment_node(user: dict,
    node_id: str,
    cascade: bool = False,
):
