...
class TestEquipmentHierarchyLibrary:
    ...
    def test_get_equipment_types(self, owner_authenticated_client):
        """Get all ISO 14224 equipment types"""
        response = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/types")
...
class TestEquipmentNodeCRUD:
    ...
    def test_get_nodes_empty(self, owner_authenticated_client):
        """Get nodes when none exist"""
        response = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes")
        assert response.status_code == 200
        data = response.json()
    ...
    def test_create_installation_node(self, owner_authenticated_client):
    ...
    def test_create_unit_under_installation(self, owner_authenticated_client):
        ...
        unit_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
            json={
                "name": unit_name,
                "level": "unit",
    ...
    def test_create_system_under_unit(self, owner_authenticated_client):
        ...
        system_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
    ...
    def test_create_full_iso_hierarchy(self, owner_authenticated_client):
        ...
        nodes_resp = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes")
        ...
        # Cleanup
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/nodes/{ids['installation']}")


class TestISOValidation:
    """Test ISO 14224 parent-child validation rules"""
    
    def test_root_must_be_installation(self, owner_authenticated_client):
    ...
    def test_invalid_parent_child_unit_under_system(self, owner_authenticated_client):
        ...
        invalid_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
    ...
    def test_invalid_equipment_directly_under_installation(self, owner_authenticated_client):
...
class TestCriticalityAssignment:
    ...
    def test_assign_criticality_basic(self, owner_authenticated_client):
        ...
        crit_resp = owner_authenticated_client.post(
    ...
    def test_assign_criticality_with_custom_values(self, owner_authenticated_client):
    ...
    def test_assign_all_criticality_levels(self, owner_authenticated_client):
...
class TestDisciplineAssignment:
    ...
    def test_assign_discipline(self, owner_authenticated_client):
    ...
    def test_invalid_discipline_rejected(self, owner_authenticated_client):
...
class TestNodeUpdateDelete:
    ...
    def test_update_node_name(self, owner_authenticated_client):
        """Update node name"""
        # Create installation
        install_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
        ...
        update_resp = owner_authenticated_client.patch(
    ...
    def test_delete_node_cascades_to_children(self, owner_authenticated_client):
        ...
        del_resp = owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/nodes/{install_id}")
        ...
        for node_id in [install_id, unit_id, system_id]:
            get_resp = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes/{node_id}")
...
class TestHierarchyStats:
    ...
    def test_get_stats(self, owner_authenticated_client):
        """Get hierarchy statistics"""
        response = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/stats")
        assert response.status_code == 200
        data = response.json()
...
class TestMoveNode:
    ...
    def test_move_unit_to_different_installation(self, owner_authenticated_client):
        """Move a unit from one installation to another"""
        # Create two installations
        install1_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
        ...
        install2_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
        ...
        move_resp = owner_authenticated_client.post(
        ...
        # Verify via GET
        get_resp = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes/{unit_id}")
        assert get_resp.status_code == 200
        assert get_resp.json()["parent_id"] == install2_id
        
        # Cleanup
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/nodes/{install1_id}")
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/nodes/{install2_id}")
        
    def test_move_system_to_different_unit(self, owner_authenticated_client):
        ...
        # Create two units
        unit1_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
        ...
        unit2_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
        ...
        # Verify via GET
        get_resp = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes/{system_id}")
        assert get_resp.json()["parent_id"] == unit2_id
        
        # Cleanup
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/nodes/{install_id}")
        
    def test_move_invalid_unit_to_system_rejected(self, owner_authenticated_client):
    ...
    def test_move_equipment_between_systems(self, owner_authenticated_client):
        ...
        equip_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/nodes",
    ...
    def test_move_to_nonexistent_parent_rejected(self, owner_authenticated_client):
    ...
    def test_move_nonexistent_node_rejected(self, owner_authenticated_client):
    ...
    def test_move_preserves_children(self, owner_authenticated_client):
        ...
        system_get = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes/{system_id}")
        assert system_get.json()["parent_id"] == unit_id
        
        # Verify unit is now under install2
        unit_get = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/nodes/{unit_id}")
...
class TestEquipmentTypeLibraryManagement:
    ...
    def test_create_custom_equipment_type(self, owner_authenticated_client):
        ...
        types_resp = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/types")
        types_list = types_resp.json()["equipment_types"]
        assert any(t["id"] == type_data["id"] for t in types_list)
        
        # Cleanup
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/types/{type_data['id']}")
        
    def test_update_custom_equipment_type(self, owner_authenticated_client):
        """Update a custom equipment type"""
        type_id = f"custom_update_{uuid.uuid4().hex[:6]}"
        
        # Create type
        create_resp = owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/types",
        ...
        # Cleanup
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/types/{type_id}")
        
    def test_delete_custom_equipment_type(self, owner_authenticated_client):
        ...
        # Delete type
        del_resp = owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/types/{type_id}")
        assert del_resp.status_code == 200
...
class TestUnstructuredItems:
    ...
    def test_parse_equipment_list(self, owner_authenticated_client):
...
Motor M-501"""
        ...
        owner_authenticated_client.delete(f"{BASE_URL}/api/equipment-hierarchy/unstructured")
        
    def test_get_unstructured_items(self, owner_authenticated_client):
        """Get list of unstructured items"""
        response = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/unstructured")
        assert response.status_code == 200
        assert "items" in response.json()
        
    def test_assign_unstructured_to_hierarchy(self, owner_authenticated_client):
        ...
        owner_authenticated_client.post(
            f"{BASE_URL}/api/equipment-hierarchy/parse-list",
            json={"content": f"Test Pump TP-{uuid.uuid4().hex[:4]}", "source": "paste"}
        )
        
        # Get unstructured items
        unstructured = owner_authenticated_client.get(f"{BASE_URL}/api/equipment-hierarchy/unstructured")
        ...
        if len(items) > 0:
            ...
            assign_resp = owner_authenticated_client.post(
